...
public class Utility {
	...
	/**
	 * Resolves the given path with the environments current directory.
	 * 
	 * @param path given path. Can be absolute or relative.
	 * @param env  environment we work in.
	 * @return given path resolved with the environments current directory.
	 */
	public static Path resolveDir(Path path, Environment env) {
